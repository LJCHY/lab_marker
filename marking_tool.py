...
presentation_options = {
    ...
    "bad_no_template": "The presentation is bad because the submitted file didn't follow the provided markdown file as its template (e.g. the cover sheet should be a separate page).",
